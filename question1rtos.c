...
void app_main(void)
{
    xTaskCreate(one_task, "one_tsk", 2048, NULL, 1, NULL);
    xTaskCreate(two_task, "two_tsk", 2048, NULL, 2, NULL);
    xTaskCreate(three_task, "three_tsk", 2048, NULL, 3, NULL);
    xTaskCreate(four_task, "four_tsk", 2048, NULL, 4, NULL);
